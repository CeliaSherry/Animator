...
/**
 * This class represents all of the methods implemented by an IEasyAnimatorView. This consists of
 * rendering the data in IEasyAnimatorModel into a format usable by the end user.
 */
