...
public class EasyAnimatorViewImplFile implements IEasyAnimatorView {
  ...
  /**
   * Renders the data in IEasyAnimatorModel in a form that is understandable for the user. Creates a
   * file with the given output name and writes the model data to thee file.
   *
