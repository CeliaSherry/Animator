...
/**
 * This interface represents all of the methods used by the Parser class.  This class takes command
 * line inputs that can be in any order and returns an array with the correct information in a
 * specific order.
 */
